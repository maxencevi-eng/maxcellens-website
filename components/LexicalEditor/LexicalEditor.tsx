...
const SITE_PAGES: { path: string; label: string }[] = [
  ...
  { path: '/portrait#lifestyle', label: 'Portrait – Lifestyle' },
  { path: '/portrait#entreprise', label: 'Portrait – Entreprise' },
  { path: '/portrait#studio', label: 'Portrait – Studio' },
  { path: '/portrait#couple', label: 'Portrait – Couple' },
